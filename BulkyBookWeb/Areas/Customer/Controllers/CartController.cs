...
namespace BulkyBookWeb.Areas.Customer.Controllers
{
    ...
    public class CartController : Controller
    {
        ...
        public IActionResult Summary()
        {
            ...
            ShoppingCartVM.OrderHeader.State = ShoppingCartVM.OrderHeader.ApplicationUser.Name;
            ...
            if (applicationUser.CompanyId.GetValueOrDefault() == 0) {
                ...
                foreach (var item in ShoppingCartVM.ListCart)
                {
                    var sessionLineItem = new SessionLineItemOptions
                    {
                        ...
                        {
                            UnitAmount = (long)(item.Price * 100),//2000 i.e.20.00 is equal to 2000 multiply by 100
                            Currency = "usd",
        ...
        public IActionResult OrderConfirmation(int id)
        {
            ...
            if (orderHeader.PaymentStatus != SD.PaymentStatusDelayedPayment)
            {
                ...
                //check for the stripe status
                if (session.PaymentStatus.ToLower() == "paid")
                {
                    _unitOfWork.OrderHeader.UpdateStripePayment(id, orderHeader.SessionId, session.PaymentIntentId);
        ...
        public IActionResult Plus(int cartId)
        {
            ...
            _unitOfWork.ShoppingCart.IncremetCount(cart, 1);
            _unitOfWork.Save();
        ...
        public IActionResult Minus(int cartId)
        {
            ...
            {
                _unitOfWork.ShoppingCart.DecremetCount(cart, 1);
            }
            _unitOfWork.Save();
            return RedirectToAction(nameof(Index));
        }
        ...
        private double GetPriceBasedOnQuantity(double qauntity, double price, double price50, double price100)
        {
            if(qauntity <= 50)
            {
                return price;
